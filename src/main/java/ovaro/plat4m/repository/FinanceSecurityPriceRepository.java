 ...
 */
@Repository
public interface FinanceSecurityPriceRepository extends JpaRepository<FinanceSecurityPrice, UUID> {
    Optional<FinanceSecurityPrice> findById(UUID id);

    Optional<FinanceSecurityPrice> findBySymbolAndDate(String symbol, ZonedDateTime date);

    List<FinanceSecurityPrice> findBySymbolOrderByDateDesc(String symbol);
