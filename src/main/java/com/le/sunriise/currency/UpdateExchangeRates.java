...
public class UpdateExchangeRates {
    ...
    private static final Logger log = LoggerFactory.getLogger(UpdateExchangeRates.class);
    ...
    protected void notifyUpdateExistingRate(
        Double rate,
        String hcrncFromStr,
        String hcrncFromName,
        String hcrncToStr,
        String hcrncToName,
        Double newRate
    ) {
    ...
    protected void notifyNoExistingRate(
        Double rate,
        String hcrncFromStr,
        String hcrncFromName,
        String hcrncToStr,
        ...
        if (log.isDebugEnabled()) {
            ...
            log.debug(
                "  CURRENT: " + hcrncFromStr + " -> " + hcrncToStr + ", " + rate + ", (" + hcrncFromName + " -> " + hcrncToName + ")"
            );
