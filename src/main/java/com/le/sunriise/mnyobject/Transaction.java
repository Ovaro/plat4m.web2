...
public interface Transaction {
    ...
    public abstract void setUserCurrencyId(Integer accountId);

    public abstract Integer getUserCurrencyId();

    public abstract BigDecimal getAmountBase();

    public abstract void setAmountBase(BigDecimal amountBase);
