...
public class TransactionImpl extends MnyObject implements Comparable<TransactionImpl>, Transaction {
    ...
    public boolean isVoid() {
        ...
        if (statusFlag == 16518) { // NOT SURE BUT CANNOT FIND ANOTHER EXPLAINATION FOR THIS CODE // JMK
            ...
            // }
            // if(transactionInfo.isBit7()) {
            //     log.info("Found Bit 7 on transation: " + guid + ", statusFlag: " + statusFlag + ", Memo:" + memo + ", Date: " + date + ", Amount: " + amount );
            // }
            log.info(
    ...
    @Override
    public void setSerialDate(Date date) {
        this.serialDate = date;
    }
    ...
    public void setPayee(Payee payeeName) {
