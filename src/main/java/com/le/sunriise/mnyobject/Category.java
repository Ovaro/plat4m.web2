...
public interface Category {
    ...
    public abstract Boolean isTax();

    public abstract Boolean isGlobal();

    public abstract Integer getType();

    public abstract void setTax(Boolean val);

    public abstract void setGlobal(Boolean val);

    public abstract void setType(Integer val);
}
