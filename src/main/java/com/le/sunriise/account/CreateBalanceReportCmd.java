...
public class CreateBalanceReportCmd extends DefaultAccountVisitor {
    ...
    private static final Logger log = LoggerFactory.getLogger(CreateBalanceReportCmd.class);
        ...
        try {
            ...
            for (AccountType accountType : balances.keySet()) {
                ...
                for (AccountBalance balance : list) {
                    ...
                    writer.println(
                        account.getName() + ", " + account.getAccountType() + ", " + account.formatAmmount(balance.getBalance())
                    );
                }
            }
        } finally {
