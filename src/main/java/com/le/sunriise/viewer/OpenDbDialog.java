...
public class OpenDbDialog extends JDialog {
    ...
    private static final Logger log = LoggerFactory.getLogger(OpenDbDialog.class);
    ...
    private final class OkAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            if (BackupFileUtils.isMnyBackupFile(dbFileName) && (!readOnlyCheckBox.isSelected())) {
                JOptionPane.showMessageDialog(
                    dbFileNames,
                    "Cannot open Money backup file write-mode.",
            ...
            try {
                ...
                OpenDbDialog.this.openedDb = openDb(
                    dbFileName,
    ...
    static OpenDbDialog showDialog(
        OpenedDb opendDb,
        List<String> recentOpenFileNames,
        Component locationRelativeTo,
        boolean disableReadOnlyCheckBox,
        final CreateOpenedDbPlugin plugin
    ) {
        String title = null;
    ...
    public OpenDbDialog(OpenedDb openedDb, String title, final List<String> recentOpenFileNames) {
        ...
        }
        {
            ...
            readOnlyCheckBox.addItemListener(
                new ItemListener() {
                    @Override
                    public void itemStateChanged(ItemEvent e) {
                        if (log.isDebugEnabled()) {
        ...
        }
        {
            ...
            encryptedCheckBox.addItemListener(
                new ItemListener() {
                    @Override
                    public void itemStateChanged(ItemEvent e) {
                        if (log.isDebugEnabled()) {
    ...
    protected void initDataBindings() {
        ...
        JComboBoxBinding<String, OpenDbDialogDataModel, JComboBox> jComboBinding = SwingBindings.createJComboBoxBinding(
            UpdateStrategy.READ,
            dataModel,
            openDbDialogDataModelBeanProperty,
            dbFileNames
        );
        jComboBinding.bind();
    }
