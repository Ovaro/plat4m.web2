...
public class MnyTableModel extends AbstractTableModel {
    ...
    private static final Logger log = LoggerFactory.getLogger(MnyTableModel.class);
    ...
    public void copyColumn(int rowIndex, int columnIndex) {
        ...
        try {
            ...
            log.info(
                "columnName=" + columnName + ", value=" + value + ", className=" + ((value == null) ? null : value.getClass().getName())
            );
