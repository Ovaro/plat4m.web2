...
public class MynViewer {
    ...
    private static final Logger log = LoggerFactory.getLogger(MynViewer.class);
    ...
    private void initialize() {
        ...
        mntmTojson.addActionListener(
            new ExportToJSONAction(
                new ExportToContext() {
                    @Override
        ...
        menuItem = new JMenuItem(
            new AbstractAction("Copy Selected Cell Value") {
                @Override
                public void actionPerformed(ActionEvent e) {
                    int rowIndex = table.getSelectedRow();
        ...
        menuItem = new JMenuItem(
            new AbstractAction("Select Column as Label") {
                @Override
                public void actionPerformed(ActionEvent e) {
                    int rowIndex = table.getSelectedRow();
                    int columnIndex = table.getSelectedColumn();
        ...
        menuItem = new JMenuItem(
            new AbstractAction("Select as Row 1") {
                @Override
                public void actionPerformed(ActionEvent event) {
                    int rowIndex = table.getSelectedRow();
        ...
        menuItem = new JMenuItem(
            new AbstractAction("Select as Row 2") {
                @Override
                public void actionPerformed(ActionEvent event) {
                    int rowIndex = table.getSelectedRow();
        ...
        JCheckBoxMenuItem checkBoxMenuItem = new JCheckBoxMenuItem(
            new AbstractAction("Enable Sorting/Filtering") {
                @Override
                public void actionPerformed(ActionEvent e) {
        ...
        filterTextField.addMouseListener(
            new PopupListener(filterCcpPopupMenu) {
                @Override
                public void mousePressed(MouseEvent e) {
    ...
    protected void initDataBindings() {
        ...
        AutoBinding<MnyViewerDataModel, String, JTextArea, String> autoBinding_4 = Bindings.createAutoBinding(
            UpdateStrategy.READ,
            dataModel,
            dataModelBeanProperty_3,
            keyInfoTextArea,
            jTextAreaBeanProperty_2
        );
        autoBinding_4.bind();
        //
                ...
                if (log.isDebugEnabled()) {
                    for (DiffData diff : diffs) {
                        if (diff.getValue1() instanceof byte[]) {
                            log.debug("DIFF columm=" + diff.getKey() + ", value1=" + "byte[]-instance" + ", value2=" + "byte[]-instance");
                        } else {
                            log.debug("DIFF columm=" + diff.getKey() + ", value1=" + diff.getValue1() + ", value2=" + diff.getValue2());
                        }
                    }
                }
