...
public class Launcher {
    ...
    public static final void addHelpMenu(final JFrame frame, final JMenuBar menuBar) {
        ...
        homePageMenuItem.addActionListener(
            new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
        ...
        wikiMenuItem.addActionListener(
            new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
        ...
        issueMenuItem.addActionListener(
            new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
    ...
    private void initialize() {
        ...
        JLabel lblNewJgoodiesLabel_3 = DefaultComponentFactory.getInstance().createLabel("MS Money file viewer (view tables, rows ...)");
        ...
        JLabel lblNewJgoodiesLabel_4 = DefaultComponentFactory.getInstance().createLabel("Accounts viewer (accounts, transactions ...)");
