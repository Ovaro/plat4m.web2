...
public abstract class AbstractBackgroundCommand implements ActionListener {
    ...
    private static final Logger log = LoggerFactory.getLogger(AbstractBackgroundCommand.class);
    ...
    public void actionPerformed(ActionEvent event) {
        if (!isRunning()) {
            ...
            if (
                JOptionPane.showConfirmDialog(parentComponent, "Stop current search?", "Request confirmation", JOptionPane.YES_NO_OPTION) ==
                ...
                public void run() {
                    if (result == null) {
                        JOptionPane.showMessageDialog(
                            parentComponent,
                            "Result of last search: NO password found.",
                            "Search Result",
