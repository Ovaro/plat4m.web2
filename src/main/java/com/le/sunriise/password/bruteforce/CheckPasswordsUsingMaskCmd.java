...
public class CheckPasswordsUsingMaskCmd {
    ...
    private static final Logger log = LoggerFactory.getLogger(CheckPasswordsUsingMaskCmd.class);
    ...
    private static char[] toAlphabets(String string) {
        ...
        if (string.compareToIgnoreCase("upper-only") == 0) {
            ...
            alphabets = GenBruteForce.appendCharArrays(
                GenBruteForce.ALPHABET_UPPERS,
                GenBruteForce.ALPHABET_LOWERS,
