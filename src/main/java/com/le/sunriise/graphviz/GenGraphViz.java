...
public class GenGraphViz {
    ...
    private static final Logger log = LoggerFactory.getLogger(GenGraphViz.class);
    ...
    private void genHeader(PrintWriter writer) {
        writer.println("// Online graphviz chart generator: https://graphviz-dev.appspot.com/");
