...
public class WaitCursorEventQueue extends EventQueue {
    ...
    private static final Logger log = LoggerFactory.getLogger(WaitCursorEventQueue.class);
        ...
        public synchronized void run() {
            while (true) {
                try {
                    ...
                    if (source instanceof Component) parent = SwingUtilities.getRoot((Component) source);
                    else if (source instanceof MenuComponent) {
                        MenuContainer mParent = ((MenuComponent) source).getParent();
                        if (mParent instanceof Component) parent = SwingUtilities.getRoot((Component) mParent);
                    }
